        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              {/* Delivery & Dispatch Info Section */}
              <div className="bg-accent/10 rounded-2xl p-6 border border-accent/20">
                <div className="flex items-center gap-3 mb-4">
                  <Truck className="text-terracotta" size={24} />
                  <h3 className="font-display text-xl font-bold text-foreground">Delivery & Dispatch</h3>
                </div>
                <div className="space-y-4 text-sm">
                  <div className="bg-background/50 p-3 rounded-lg">
                    <p className="font-semibold text-terracotta">Next Day Dispatch</p>
                    <p className="text-muted-foreground">Spices and Multigrain flours</p>
                  </div>
                  <div className="bg-background/50 p-3 rounded-lg">
                    <p className="font-semibold text-terracotta">48-Hour Dispatch</p>
                    <p className="text-muted-foreground">Chutneys, Laddus, Biscuits, and Cookies</p>
                  </div>
                  <div className="flex items-center gap-2 pt-2 text-foreground font-medium">
                    <span className="bg-primary text-primary-foreground px-2 py-1 rounded text-xs italic">Estimated Delivery</span>
                    <span>7 Days from dispatch</span>
                  </div>
                </div>
              </div>
